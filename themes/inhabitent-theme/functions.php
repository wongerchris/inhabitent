...
function inhabitent_starter_scripts() {
	...
	wp_enqueue_script( 'main', $script_url, array( 'jquery' ),'2.2', true);
...
function red_wp_trim_excerpt( $text ) {
	...
	if ( '' == $text ) {
		...
		$excerpt_end = '<span>[...]</span><p><a href="' . get_permalink() . '" class="btn btn-black">Read more &rarr;</a></p>'; // modify excerpt ending
